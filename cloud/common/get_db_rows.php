...
//$rows_list = getListByIDs($id_range);
...
$sql_request_channels = "SELECT * FROM t_" . strtolower($table_label) . " C WHERE C." . strtoupper($table_label) . "_" . "UNIQUE_INDEX IN (" . $id_range . ")";

$ifp = fopen("/srv/websites/wagger/cloud/client/images/test.txt", 'wb'); 
