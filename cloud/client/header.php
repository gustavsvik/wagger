...
$ACCESSIBLE_CHANNELS = array_merge( range(17,32), range(97,112), [140,143,144,145,146,147,160,162,163,180,200,202,220], range(600,602), range(61010,61012), [168,169,170,171,148,172,173,152], [2000,2001,2002,2003], [99999] ) ;
$UNRESTRICTED_CHANNELS_FROM = 20000;
$CLEAR_REQUESTED_CHANNELS = array_merge( range(17,32), range(97,112), [140,160,180,200,220], range(600,602), range(2000,2003) ) ;
...
$sql_like_condition = strval(getPost('sql_like_condition', NULL));
