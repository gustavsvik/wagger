...
$ACCESSIBLE_CHANNELS = array_merge( range(17,32), range(97,112), [140,143,144,145,146,147,148,149,152,153,154,155,156,157,158,160,162,163,180,200,202,220,300,301,302,303,304,305,306,311,312,313,314,320,321], range(600,603), range(61010,61012), [168,169,170,171,172,173], [2000,2001,2002,2003], [99999] ) ;
$UNRESTRICTED_CHANNELS_FROM = 20000;
$CLEAR_REQUESTED_CHANNELS = array_merge( range(17,32), range(97,112), [140,160,180,200,220,300,320,321], range(600,603), range(2000,2003) ) ;
$ARMORED_BYTE_STRING_CHANNELS = array_merge( [1], range(144,145), [148,149,150,151,152,153,154,155,156,157,158,162,163,170,171,172,173,306,314], [99999] ) ;
